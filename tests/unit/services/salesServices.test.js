...
describe("Testa a função checkExistSale da salesService", () => {
describe("A função checkExistsSale", () => {
  ...
  it("Deve lançar um erro caso não encontre a venda", () => {
    ...
    chai.expect(salesService.checkExistsSale(1)).to.eventually.throws({
      status: 404,
...
describe("Testa a função delete da salesService", () => {
describe("A função delete", () => {
  ...
  it("Deve lançar um erro caso dê problema no DB", () => {
    ...
    chai.expect(salesService.delete(1)).to.eventually.be.rejected;
  });
